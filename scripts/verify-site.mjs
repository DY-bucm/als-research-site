...
const pages = ["index.html", "detail.html", "briefing.html", "trials.html", "topics.html", "review.html", "quality.html", "export.html", "status.html"];
const requiredAssets = ["assets/styles.css", "data/items.json", "data/review-overrides.json", "data/quality-report.json", "data/status.json"];
const failures = [];
